...
<html lang="en">
    <head>
        ...
        <!-- Styles -->
        <link type="text/css" rel="stylesheet" href="<?php echo base_url();?>assets/plugins/materialize/css/materialize.css"/>
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                        ...
                        <div class="col s12 m4 search-result-container">
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="<?php echo base_url();?>assets/images/profile-image-1.png" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="<?php echo base_url();?>assets/images/profile-image-3.jpg" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
                            ...
                            <div class="card card-transparent">
                                <div class="row valign-wrapper">
                                    <div class="col s3">
                                        <img src="<?php echo base_url();?>assets/images/profile-image.png" alt="" class="circle responsive-img z-depth-1">
                                    </div>
                                    <div class="col s9">
                                        <span class="search-result-text">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <div class="footer">
                    <p class="copyright">POLITEKNIK JEMBER ©</p>
                    <a href="#!">Teknologi Informatika</a>
                </div>
                </div>
            </aside>
