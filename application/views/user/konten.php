								...
								<aside class="section section-services service-layout-1">
									<div class="container">
										<div class="section-title-wrap">
											...
											<p class="section-subtitle"> bagaimana ini perusahaan berdiri , jualan, berprestasi, dll </p>
										</div>
									...
									<div class="container">
										<div class="latest-posts-section">
											<div class="section-title-wrap">
												...
												<p class="section-subtitle">Saling Sharing pengalaman membuat hari menjadi lebih baik</p>
								...
								<aside class="section section-teams">
									<div class="container">
										<div class="section-title-wrap">
											...
											<p class="section-subtitle">Diantaranya</p>
										</div> <!-- .section-title-wrap -->
