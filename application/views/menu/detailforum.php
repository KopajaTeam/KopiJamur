													...
													<article class="comment-body">
														<footer class="comment-meta">
															<div class="comment-author vcard">
																...
																<b class="fn">
																	<a href="#" class="url"><?php echo "Nama User"; ?></a> </b>
																	<span class="says">says:</span>
																...
																<div class="comment-metadata">
																	<a href="#" >
																		<span>
																			<?php echo "Tanggal Komentar"; ?> </span>
																		</a>
																	</div><!-- .comment-metadata -->
																</footer><!-- .comment-meta -->
																<div class="comment-content">
											...
											<div id="respond" class="comment-respond">
												...
												<form action="http://anilbasnet.com/demo/biz-lina/."  id="commentform" class="comment-form">
													<p class="comment-notes">
														...
														</span> Silakan Login Terlebih dahulu <span class="required">*</span>
													</p>
