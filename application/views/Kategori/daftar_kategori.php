...
<main class="mn-inner">
    <div class="row">
        <div class="col s12">
            <div class="page-title page-center"><h4>Data Kategori</h4></div>
        ...
        <div class="col s12 m12 l12">
            <div class="card">
                <div class="card-content">
                    ...
                    <a href="<?php echo base_url()?>Kategori/input" class="waves-effect waves-light btn btn-large btn-floating green z-depth-1 btn-tambah"><i class="large material-icons">add</i></a>
                    </div>
                    <br>
...
<!--                                <a href="--><?php //echo base_url().'Customer/edit/'.$data->id?><!--" class="waves-effect waves-light btn btn-xs btn-floating orange"><i class="material-icons">edit</i></a>-->
                                <?php echo $this->Fungsi_Tampilan->Modal_Edit($data->id, "Kategori/edit/".$data->id); ?>
                            </td>
                        </tr>
                        <?php $no++; } ?>
                        </tbody>
