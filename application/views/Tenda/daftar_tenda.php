 ...
 */
?>
<?php echo form_open('Tenda/delete');?>
<main class="mn-inner">
    <div class="row">
        <div class="col s12">
            <div class="page-title page-center"><h4>Data Tenda</h4></div>
        ...
        <div class="col s12 m12 l12">
            <div class="card">
                <div class="card-content">
                    ...
                    <a href="<?php echo base_url()?>Tenda/input" class="waves-effect waves-light btn btn-large btn-floating green z-depth-1 btn-tambah"><i class="large material-icons">add</i></a>
                    </div>
                    <br>
                    <table id="example" class="display responsive-table datatable-example ">
                        ...
                        <tr>
                            ...
                            <td><?php echo $data->nama_tenda?></td>
                            <td><?php echo $data->ukuran_tenda?></td>
...
<!--                                <a href="--><?php //echo base_url().'Customer/edit/'.$data->id?><!--" class="waves-effect waves-light btn btn-xs btn-floating orange"><i class="material-icons">edit</i></a>-->
                                <?php echo $this->Fungsi_Tampilan->Modal_Edit($data->id, "Tenda/edit/".$data->id); ?>
                                <?php echo $this->Fungsi_Tampilan->Modal_Default_Tenda($data->id, "Tenda/DefaultTenda/".$data->id); ?>
                            </td>
                        </tr>
                        <?php $no++; } ?>
                        </tbody>
